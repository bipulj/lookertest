# The name of this view in Looker is "Links2"
view: links2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `dataset_in_us.links2`
    ;;
...
# The name of this view in Looker is "Links2 Sort Keys"
view: links2__sort_keys {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.

  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Links2 Sort Keys" in Explore.

  dimension: links2__sort_keys {
    type: number
    sql: links2__sort_keys ;;
  }
  ...
  measure: total_links2__sort_keys {
    type: sum
    sql: ${links2__sort_keys} ;;
  }

  measure: average_links2__sort_keys {
    type: average
    sql: ${links2__sort_keys} ;;
  }
}

# The name of this view in Looker is "Links2 Source Metadata Primary Keys"
view: links2__source_metadata__primary_keys {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.

  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Links2 Source Metadata Primary Keys" in Explore.

  dimension: links2__source_metadata__primary_keys {
    type: string
    sql: links2__source_metadata__primary_keys ;;
  }
}
